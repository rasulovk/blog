# CyberCode - Tailwind CSS Company Landing Page
...
CyberCode is an open-source and free Tailwind CSS template created by [rasul](https://github.com/rasul). Crafted for company website and can be used with almost all sort of web project. This template is Tailwind CSS version of [Inazuma](https://github.com/rasul/inazuma) template with more refreshing design in it.
...
You can see the live demo [here](https://cybercode.az).
...
This project is a simple landing page for a cybersecurity audit service, built with Tailwind CSS and TailGrids UI blocks. The page highlights services such as ISO 27001, ISO 27002, and NIST compliance audits.

## Features
- Responsive design using Tailwind CSS.
- Pre-designed UI blocks from TailGrids.
...
1. Build the Docker image:
   ```bash
   docker build -t infosec-page .
   ```
2. Run the container:
   ```bash
   docker run --rm -p 8182:80 infosec-page 
   ```
3. Open your browser and navigate to `http://localhost:8182`.
